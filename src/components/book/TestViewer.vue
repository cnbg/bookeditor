      ...
      <div v-if="isSurveyCompleted">
        <Toolbar>
            ...
            <Message severity="success" :closable="false">      
              <p class="text-lg font-medium text-600">{{$t('general.correct-answers')}}: <Badge value="" size="large" >{{ rightCount }}</Badge></p>
            </Message>
            <Message severity="error" :closable="false">
              <p class="text-lg font-medium text-600">{{$t('general.incorrect-answers')}}: <Badge value="" size="large" style="background-color: red;">{{ wrongCount }}</Badge></p>
            </Message>
            </div>
           </template>
       </Toolbar>
